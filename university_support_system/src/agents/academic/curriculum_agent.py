...
class CurriculumAgent(BaseSpecialistAgent):
    ...
    async def _try_build_prerequisite_response(
        ...
        *,
        ...
        # Check for general/policy prerequisite inquiries to allow RAG fallback
        general_markers = (
            "genel", "kural", "sart", "esas", "yonetmelik", "yonerge", "dikkat", "limit", "sinir", "baraj",
            "dersleri icin onkosul", "dersleri icin on kosul", "derslerinde onkosul", "derslerinde on kosul",
            "bolumu dersleri", "bolumunun dersleri"
        )
