...
Kullanim:
  ...
  python scripts/followup_benchmark.py                   # Tum gruplar
  python scripts/followup_benchmark.py --group A          # Tek grup
  python scripts/followup_benchmark.py --group A B        # Birden fazla grup
  python scripts/followup_benchmark.py -v                 # Verbose mod
"""
