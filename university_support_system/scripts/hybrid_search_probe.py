...
Kullanım:
    python scripts/hybrid_search_probe.py "kayıt dondurma nasıl yapılır"
    python scripts/hybrid_search_probe.py "Çift anadal başvurusu nasıl yapılır"
    python scripts/hybrid_search_probe.py "yaz okulu harç ücreti" --bm25-weight 0.6
    python scripts/hybrid_search_probe.py "Müfredat nedir" --department academic_programs
"""
