# Shadow Decision Trace Golden Run 20260514_152032
...
- Trace JSONL: `C:\Users\ÖMER FARUK DERİN\Desktop\bitirme projesi\university_support_system\university_support_system\tmp\shadow_decision_trace_golden_20260514_152032.jsonl`
- Makine okunabilir sonuc: `C:\Users\ÖMER FARUK DERİN\Desktop\bitirme projesi\university_support_system\university_support_system\tests\archive\benchmarks\shadow_decision_trace_golden_20260514_152032.json`
...
- Tahmini input token: 16857 (5 cagrida)
- Prompt/system char: 38504/28930
- Role bazli cagri sayisi: global_synthesis=2, judge=1, routing=2
- Role bazli tahmini input token: global_synthesis=8100, judge=1446, routing=7311
...
- First-case latency ms: `90199.55`
...
- Context: `shadow-golden-20260514_152032-GT04`
...
- LLM usage: `groq/llama-3.3-70b-versatile/routing/primary/success/in_tok~4273; groq/llama-3.3-70b-versatile/routing/primary/success/in_tok~3038; groq/llama-3.3-70b-versatile/global_synthesis/primary/success/in_tok~6816; groq/llama-3.3-70b-versatile/judge/primary/success/in_tok~1446; groq/llama-3.3-70b-versatile/global_synthesis/primary/success/in_tok~1284`
- Provider retry attempts: `[{"attempt": 1, "context_id": "shadow-golden-20260514_152032-GT04", "status": "OK", "retryable_provider_error": false, "provider_errors": []}]`
- Timeout signals: `{"capability_planner_ms": 2638.087, "capability_planner_timeout_suspected": false, "routing_ms": 1955.202, "routing_timeout_suspected": false, "conversation_ms": 222.434, "final_synthesis_ms": 2115.906}`
- Cevap preview: Benchmark, Kayıt yaptırdığınız öğretim yılının en geç 3. haftasının sonuna kadar, daha önce aldığınız ve başarılı olduğunuz derslerden muaf olmak için Dekanlığa/Müdürlüğe başvurabilirsiniz. • Kayıt yaptırdığınız öğretim yılının en geç 3. haftasının sonuna kadar muafiyet başvurunuzu yapabilirsiniz. • Başvuru işlemi için transkriptinizi ve ders içeriklerinizi dekanlığa vermeniz gerekmektedir. • Yatay Geçiş İnceleme ve İntibak Komisyonu, muafiyet istediğiniz ders/bloklar ile ilgili incelemeyi yaparak, muafiyet kararını verecektir. Üretim Türü: - Final Sentez: LLM - Ogrenci Isleri: RAG - Akademik Programlar: RAG - Routing: parallel - Pipeline: student_affairs -> academic_programs -> orchestrator Kaynak Özeti: - Belge: sık_sorulan_sorular.txt - Belge: diş_hekimliği_fakültesı_lisans_eğitim_öğretim_yönergesi.pdf - Belge: mezunlar_için_pedagojik_formasyon_eğitimi.pdf - Belge: uluslararası_işbirlikleri_protokoller_kapsamındaki_öğrenci_ve_personel_değişim.pdf - Belge: yonerge_uluslararasi_ogrenci_yatay_gecis.pdf
