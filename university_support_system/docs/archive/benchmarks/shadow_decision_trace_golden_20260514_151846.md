# Shadow Decision Trace Golden Run 20260514_151846
...
- Trace JSONL: `C:\Users\ÖMER FARUK DERİN\Desktop\bitirme projesi\university_support_system\university_support_system\tmp\shadow_decision_trace_golden_20260514_151846.jsonl`
- Makine okunabilir sonuc: `C:\Users\ÖMER FARUK DERİN\Desktop\bitirme projesi\university_support_system\university_support_system\tests\archive\benchmarks\shadow_decision_trace_golden_20260514_151846.json`
...
- Tahmini input token: 17563 (4 cagrida)
- Prompt/system char: 42931/27326
- Role bazli cagri sayisi: global_synthesis=1, judge=1, routing=2
- Role bazli tahmini input token: global_synthesis=8879, judge=1373, routing=7311
...
- First-case latency ms: `96116.23`
...
- Context: `shadow-golden-20260514_151846-GT04`
...
- LLM usage: `groq/llama-3.3-70b-versatile/routing/primary/success/in_tok~4273; groq/llama-3.3-70b-versatile/routing/primary/success/in_tok~3038; groq/llama-3.3-70b-versatile/global_synthesis/primary/success/in_tok~8879; groq/llama-3.3-70b-versatile/judge/primary/success/in_tok~1373`
- Provider retry attempts: `[{"attempt": 1, "context_id": "shadow-golden-20260514_151846-GT04", "status": "OK", "retryable_provider_error": false, "provider_errors": []}]`
- Timeout signals: `{"capability_planner_ms": 1595.822, "capability_planner_timeout_suspected": false, "routing_ms": 1364.543, "routing_timeout_suspected": false, "conversation_ms": 191.128, "final_synthesis_ms": 1751.485}`
- Cevap preview: Benchmark, Kayıt yaptırdığı öğretim yılının en geç 3 hafta içinde muafiyet başvurusu yapmalısınız. --- Daha iyi yardımcı olabilmem için sorunuzu daha detaylı açıklayabilirsiniz ya da ilgili sekreterin iletişim bilgilerini paylaşırım. "İletişim bilgisi" yazarak ulaşabilirsiniz. Üretim Türü: - Final Sentez: LLM - Ogrenci Isleri: RAG - Akademik Programlar: RAG - Routing: parallel - Pipeline: student_affairs -> academic_programs -> orchestrator Kaynak Özeti: - Belge: ön_lisans_ve_lisans_yatay_geçiş_yönergesi.pdf - Belge: mezunlar_için_pedagojik_formasyon_eğitimi.pdf - Belge: diş_hekimliği_fakültesı_lisans_eğitim_öğretim_yönergesi.pdf - Belge: uluslararası_işbirlikleri_protokoller_kapsamındaki_öğrenci_ve_personel_değişim.pdf - Belge: önlisans_ve_lisans_düzeyindeki_programlar_arasında_geçiş_yönergesi.pdf - Belge: yonerge_uluslararasi_ogrenci_yatay_gecis.pdf
