# Shadow Decision Trace Golden Run 20260514_174026
...
- Trace JSONL: `C:\Users\ÖMER FARUK DERİN\Desktop\bitirme projesi\university_support_system\university_support_system\tmp\shadow_decision_trace_golden_20260514_174026.jsonl`
- Makine okunabilir sonuc: `C:\Users\ÖMER FARUK DERİN\Desktop\bitirme projesi\university_support_system\university_support_system\tests\archive\benchmarks\shadow_decision_trace_golden_20260514_174026.json`
...
- Tahmini input token: 8578 (4 cagrida)
- Prompt/system char: 6994/27326
- Role bazli cagri sayisi: global_synthesis=1, judge=1, routing=2
- Role bazli tahmini input token: global_synthesis=614, judge=658, routing=7306
...
- First-case latency ms: `73929.78`
...
- Context: `shadow-golden-20260514_174026-GT04`
...
- LLM usage: `groq/llama-3.3-70b-versatile/routing/primary/success/in_tok~4273; groq/llama-3.3-70b-versatile/routing/primary/success/in_tok~3033; groq/llama-3.3-70b-versatile/judge/primary/success/in_tok~658; groq/llama-3.3-70b-versatile/global_synthesis/primary/success/in_tok~614`
- Provider retry attempts: `[{"attempt": 1, "context_id": "shadow-golden-20260514_174026-GT04", "status": "CHECK", "retryable_provider_error": false, "provider_errors": []}]`
- Timeout signals: `{"capability_planner_ms": 2807.667, "capability_planner_timeout_suspected": false, "routing_ms": 4670.551, "routing_timeout_suspected": false, "conversation_ms": 240.928, "final_synthesis_ms": null}`
- Cevap preview: Benchmark, Yatay geçiş ile gelen öğrenci muafiyet başvurusu, genel olarak akademik takvimde belirtilen tarihlerde yapılır. Ancak, bu tarihleri kesin olarak belirlemek için öğrenci işleri veya akademik programlar birimlerine başvurarak güncel bilgi almak gerekir. Üretim Türü: - Ogrenci Isleri: Kural - Akademik Programlar: Kural - Routing: parallel - Pipeline: student_affairs -> academic_programs Kaynak Özeti: - Veritabani kaydi: ogrenci isleri
