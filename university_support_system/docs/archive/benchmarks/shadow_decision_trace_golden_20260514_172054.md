# Shadow Decision Trace Golden Run 20260514_172054
...
- Trace JSONL: `C:\Users\ÖMER FARUK DERİN\Desktop\bitirme projesi\university_support_system\university_support_system\tmp\shadow_decision_trace_golden_20260514_172054.jsonl`
- Makine okunabilir sonuc: `C:\Users\ÖMER FARUK DERİN\Desktop\bitirme projesi\university_support_system\university_support_system\tests\archive\benchmarks\shadow_decision_trace_golden_20260514_172054.json`
...
- Tahmini input token: 8631 (4 cagrida)
- Prompt/system char: 7206/27326
- Role bazli cagri sayisi: global_synthesis=1, judge=1, routing=2
- Role bazli tahmini input token: global_synthesis=656, judge=662, routing=7313
...
- First-case latency ms: `83774.79`
...
- Context: `shadow-golden-20260514_172054-GT04`
...
- LLM usage: `groq/llama-3.3-70b-versatile/routing/primary/success/in_tok~4273; groq/llama-3.3-70b-versatile/routing/primary/success/in_tok~3040; groq/llama-3.3-70b-versatile/judge/primary/success/in_tok~662; groq/llama-3.3-70b-versatile/global_synthesis/primary/success/in_tok~656`
- Provider retry attempts: `[{"attempt": 1, "context_id": "shadow-golden-20260514_172054-GT04", "status": "CHECK", "retryable_provider_error": false, "provider_errors": []}]`
- Timeout signals: `{"capability_planner_ms": 1588.863, "capability_planner_timeout_suspected": false, "routing_ms": 1624.56, "routing_timeout_suspected": false, "conversation_ms": 140.974, "final_synthesis_ms": null}`
- Cevap preview: Benchmark, Yatay geçiş ile gelen öğrencilerin muafiyet başvuruları hakkında bilgi almak için Ondokuz Mayıs Üniversitesi web sitesini ziyaret edebilir veya öğrenci işleri bölümüne başvurabilirsiniz. Üretim Türü: - Ogrenci Isleri: Kural - Akademik Programlar: Kural - Routing: parallel - Pipeline: student_affairs -> academic_programs Kaynak Özeti: - Veritabani kaydi: ogrenci isleri
