# Shadow Decision Trace Golden Run 20260514_153844
...
- Trace JSONL: `C:\Users\ÖMER FARUK DERİN\Desktop\bitirme projesi\university_support_system\university_support_system\tmp\shadow_decision_trace_golden_20260514_153844.jsonl`
- Makine okunabilir sonuc: `C:\Users\ÖMER FARUK DERİN\Desktop\bitirme projesi\university_support_system\university_support_system\tests\archive\benchmarks\shadow_decision_trace_golden_20260514_153844.json`
...
- Tahmini input token: 15609 (4 cagrida)
- Prompt/system char: 35117/27326
- Role bazli cagri sayisi: global_synthesis=1, judge=1, routing=2
- Role bazli tahmini input token: global_synthesis=6966, judge=1336, routing=7307
...
- First-case latency ms: `159193.36`
...
- Context: `shadow-golden-20260514_153844-GT04`
...
- LLM usage: `groq/llama-3.3-70b-versatile/routing/primary/success/in_tok~4273; groq/llama-3.3-70b-versatile/routing/primary/success/in_tok~3034; groq/llama-3.3-70b-versatile/global_synthesis/primary/success/in_tok~6966; groq/llama-3.3-70b-versatile/judge/primary/success/in_tok~1336`
- Provider retry attempts: `[{"attempt": 1, "context_id": "shadow-golden-20260514_153844-GT04", "status": "OK", "retryable_provider_error": false, "provider_errors": []}]`
- Timeout signals: `{"capability_planner_ms": 1828.661, "capability_planner_timeout_suspected": false, "routing_ms": 2663.409, "routing_timeout_suspected": false, "conversation_ms": 496.865, "final_synthesis_ms": 1680.067}`
- Cevap preview: Benchmark, Kayıt yaptırdığı öğretim yılının en geç 3. haftası içinde muafiyet başvurusu yapabilirsiniz. --- Daha iyi yardımcı olabilmem için sorunuzu daha detaylı açıklayabilirsiniz ya da ilgili sekreterin iletişim bilgilerini paylaşırım. "İletişim bilgisi" yazarak ulaşabilirsiniz. Üretim Türü: - Final Sentez: LLM - Ogrenci Isleri: RAG - Akademik Programlar: RAG - Routing: parallel - Pipeline: student_affairs -> academic_programs -> orchestrator Kaynak Özeti: - Belge: ders_yeterlik_muafiyet_ve_intibak_yönergesi.pdf - Belge: yonerge_dis_hekimligi_lisans_egitim_ogretim.pdf - Belge: mezunlar_için_pedagojik_formasyon_eğitimi.pdf - Belge: diş_hekimliği_fakültesı_lisans_eğitim_öğretim_yönergesi.pdf - Belge: uluslararası_işbirlikleri_protokoller_kapsamındaki_öğrenci_ve_personel_değişim.pdf - Belge: yonerge_uluslararasi_ogrenci_yatay_gecis.pdf
