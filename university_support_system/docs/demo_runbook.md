...
> Not: Bu belge demo ve benchmark operasyonu icin gunceldir; kurulum ve altyapi hazirligi icin once `README.md`, `KURULUM_VE_CALISTIRMA.md` ve gerekiyorsa `AZURE_VM_RUNBOOK.md` okunmalidir.
...
### 6. Follow-up / konusma baglami gosterimi
